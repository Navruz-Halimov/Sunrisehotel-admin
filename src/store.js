...
const actions = {
  ...
  async getmenuslider({ commit }) {
    ...
    await axios.get("menu/admin/image/")
      .then((res) => {
        console.log(res);
  ...
  async getmenuoffers({ commit }) {
    ...
    await axios.get("/menu/admin/offer/")
      .then((res) => {
  ...
  async getOffers({ commit }) {
    ...
    await axios.get("offers/admin/offer/")
      .then((res) => {
  ...
  async getDiscount({ commit }) {
    ...
    await axios.get('offers/admin/discount/')
      .then((res) => {
  ...
  async getReservation({ commit }) {
    ...
    await axios.get('reservation/admin/')
      .then((res) => {
